...
#define ZDISPLAY_VERSION_MINOR 0
#define ZDISPLAY_VERSION_PATCH 0

#define ZDISPLAY_VERSION_COMMA 1,0,0,0   ///< VERSIONINFO requires four fields
#define ZDISPLAY_VERSION_STR   "1.0.0"
#define ZDISPLAY_VERSION_WSTR  L"1.0.0"
