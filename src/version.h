...
#define ZDISPLAY_VERSION_MINOR 2
#define ZDISPLAY_VERSION_PATCH 5

#define ZDISPLAY_VERSION_COMMA 1,2,5,0   ///< VERSIONINFO requires four fields
#define ZDISPLAY_VERSION_STR   "1.2.5"
#define ZDISPLAY_VERSION_WSTR  L"1.2.5"
